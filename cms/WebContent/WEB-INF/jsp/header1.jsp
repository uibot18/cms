    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link cms_menu_item" href="taskQuestionnaire?action=search" aria-expanded="false"><i class="mdi mdi-check-circle"></i><span class="hide-menu">Task Questionnaire</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link cms_menu_item" href="customerBooking?action=search" aria-expanded="false"><i class="mdi mdi-notification-clear-all"></i><span class="hide-menu">Customer Booking</span></a></li>
