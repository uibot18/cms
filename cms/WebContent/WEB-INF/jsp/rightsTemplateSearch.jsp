...
<%@page import="java.util.Map"%>
 ...
 <%
   ...
   if(resultMap==null){ resultMap=new HashMap<String, Object>(); }
	...
	String rightsTemplateName=AppUtil.getNullToEmpty( requestMap.get("rightsTemplateName") );
...
<div class="container-fluid">
      ...
      <div class="row">
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                  	<h4 class="card-title">RIGHTS TEMPLATE SEARCH
                  		<button type="button" data-toggle="modal" data-target="#CMS-POPUP-MODEL" data-url="rightsTemplate?action=add" class="btn btn-primary btn-sm float-right btn-rounded" style="">
                   		<i class="fa fa-plus"></i> 
                   		ADD
                   	</button>
                  	</h4>
                      <form id="<%=formName %>" class="form p-t-20" action="rightsTemplate?action=search" method="post">
                      	<div class="row">
                      		<div class="col-sm-8">
                      			<div class="form-group row">
                                <label for="rightsName" class="col-sm-3 p-t-5  control-label col-form-label">Rights Template Name</label>
                                <div class="col-sm-8">
                                    <input type="text" name="rightsTemplateName" class="form-control form-control-sm" id="rightsTemplateName" value="<%=rightsTemplateName %>" placeholder="Rights Template Name">
                                </div>
                            </div>
                      		</div>
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      <h4 class="card-title">Rights Template List</h4>
                  </div>
                       ...
                       <table class="table table-bordered text-center">
                           <thead>
                               <tr>
                                   ...
                                   <th scope="col">Rights Template Name</th>
                           ...
                           List<Map<String, Object>> resultList=(List<Map<String, Object>>)resultMap.get( SearchEnum.RESULT_LIST.getKeyName() );
							...
							for(Map<String, Object> searchData:resultList){
								...
								int rights_template_id=AppUtil.getNullToInteger( (String)searchData.get("COL#1") );
								
								String template_name=AppUtil.getNullToEmpty( (String)searchData.get("COL#2") );
							...
							%>
								<tr>
									...
									<td>
										<a data-target="#CMS-POPUP-MODEL" data-toggle="modal"  data-url="rightsTemplate?action=edit&rightsTemplateId=<%=rights_template_id%>" href="#">Edit</a> &nbsp;&nbsp;
										<a class='<%=formName %>_delete' href="javascript:;" ahref="rightsTemplate?action=delete&rightsTemplateId=<%=rights_template_id%>">delete</a></td>
								</tr>
							<%sno++;
							} %>
                           </tbody>
