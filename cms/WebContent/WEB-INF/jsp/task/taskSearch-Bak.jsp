			    ...
			    <div class="col-md-12 col-sm-12">
			        <div id="with-header" class="card">
			            <div class="card-header">
			                <h4 class="card-title">Task Search</h4>
			                ...
			                <div class="heading-elements">
			                    <ul class="list-inline mb-0">
			                        ...
			                        <li>
			                    		<a  id="testId" class="" data-toggle="modal" data-target="#CMS-POPUP-MODEL" data-url="task?action=add&taskType=<%=TaskType.Customer.getType()%>"> 
			                    			<b>+&nbsp;Customer Task</b>
										</a>
			                    	</li>
			                    	<li>
			                    		<a  id="testId" class="" data-toggle="modal" data-target="#CMS-POPUP-MODEL" data-url="task?action=add&taskType=<%=TaskType.GeneralTask.getType()%>"> 
			                    			<b>+&nbsp;General Task</b>
										</a>
			                    	</li>
			                    </ul>
