...
public class PackageSearchController {
	...
	private static String constructQuery(Map<String, String> requestMap, HttpServletRequest request, HttpServletResponse response) {
		...
		String query="SELECT a.cmn_master_id, a.cmn_group_id, a.parent_id, b.cmn_master_name AS service_name, a.cmn_master_name AS package_name, a.level_no " + 
				"FROM common_master a, common_master b  " + 
				"WHERE a.cmn_group_id="+CmnGroupName.PACKAGE.getGroupId()+" AND a.bool_delete_status=0 AND a.parent_id=b.cmn_master_id AND b.cmn_group_id="+CmnGroupName.SERVICE.getGroupId()+" "
