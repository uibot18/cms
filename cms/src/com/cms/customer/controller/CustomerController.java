...
public class CustomerController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("search")) { 
			...
			doCustomerSave( request, response );
			request.getRequestDispatcher("WEB-INF/jsp/customerAddUpdate.jsp").forward(request, response);
		}else if(action.equalsIgnoreCase("edit")) {
			doCustomerEdit( request, response );
			request.getRequestDispatcher("WEB-INF/jsp/customerAddUpdate.jsp").forward(request, response);
		}
	...
	private void doCustomerEdit(HttpServletRequest request, HttpServletResponse response) {
	...
	private void doCustomerSave(HttpServletRequest request, HttpServletResponse response) {
		...
		if(customerDO!=null) {
			...
			if(customerDO.getCustomerId()==0) {
				...
				if(customerId!=0) {
					...
					System.out.println("Customer Data Inserted, Id : "+customerId );
				}else {
	...
	private SalesCustomerMasterDO costructDTO(HttpServletRequest request, HttpServletResponse response) {
